...
Mathematic uses AI agents to maintain this repository. Reviewing an unsolicited pull request usually takes longer than implementing a proposal after we agree on its scope.

## Propose a change

1. Start a [GitHub Discussion](../../discussions/new) describing the problem, the outcome you want, and any constraints.
